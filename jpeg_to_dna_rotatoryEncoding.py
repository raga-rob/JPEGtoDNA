...
Usage examples:
  python jpeg_to_dna.py input.jpg -o out.fasta -l 1124 --rs_pad_prbs --no_pad_header
  python jpeg_to_dna.py input.jpg -o out.fasta -l 1124 --rs_pad_prbs --no_pad_header --whiten #### BEST FOR DNA SYNTHESIS
  python jpeg_to_dna.py input.jpg -o out.fasta -l 1296 
  python jpeg_to_dna.py input.jpg -o out.fasta -l 1400 --rs_pad_prbs --rs_k 191 --whiten
